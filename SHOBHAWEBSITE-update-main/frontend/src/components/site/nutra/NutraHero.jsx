...
export default function NutraHero() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(120deg, #12233D 0%, #0A4A3E 55%, #5e8722 100%)",
      }}
    >
      {/* Decorative layers — match Pharma / About hero style */}
      <div className="absolute inset-0 dot-grid opacity-20 pointer-events-none" />
      <div className="absolute -top-32 -right-32 w-[520px] h-[520px] rounded-full bg-[#9DCD4A]/25 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-32 w-[520px] h-[520px] rounded-full bg-[#62C7F5]/15 blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16 py-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-7">
              <Leaf className="w-3.5 h-3.5 text-[#9DCD4A]" />
            ...
            {/* H1 */}
            <h1
              data-testid="nutra-hero-headline"
            ...
            <p className="mt-7 text-white/75 text-[16px] md:text-[17px] leading-relaxed max-w-2xl">
              Women's Health · Men's Health · Bones &amp; Joints · Immunity ·
              Cognitive Support · Daily Essentials — manufactured under strict
              GMP standards with pure, validated ingredients.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="text-white font-medium">Nutraceuticals</span>
            </nav>
            ...
            <div className="flex-1 flex items-center">
              <div className="grid grid-cols-2 gap-x-10 gap-y-7">
                {[
                  { v: "15", l: "Products" },
                  { v: "1", l: "Brand · Essentiale" },
                  { v: "GMP", l: "Certified" },
                  { v: "100%", l: "Pure Ingredients" },
                ].map((s) => (
                  <div key={s.l} className="flex flex-col">
                    <span className="font-display font-semibold text-white text-[28px] md:text-[36px] leading-none">
                      {s.v}
                    </span>

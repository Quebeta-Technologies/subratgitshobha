...
// ─────────────────────────────────────────────────────────────────────────────
// 15 Essentiale Nutraceutical Products
// Each product has a category-themed icon + colour for visual variety.
// ─────────────────────────────────────────────────────────────────────────────
const products = [
  {
    sno: 1,
    ...
    desc:
      "Daily intimate flora support formulated for women — promotes balanced vaginal microflora and overall feminine wellness.",
    icon: Heart,
    color: "#E84D6C",
  ...
  },
  {
    ...
    desc:
      "Comprehensive multivitamin and multimineral blend covering essential daily nutrition from A through Z — fills the gaps a regular diet leaves behind.",
    icon: Sparkles,
    color: "#7A1F7A",
  ...
  },
  {
    ...
    desc:
      "Easy-on-the-stomach iron formulation to help correct iron deficiency and support healthy haemoglobin levels — ideal for women, teens, and donors.",
    icon: Droplets,
    color: "#C2410C",
  ...
  },
  {
    ...
    desc:
      "Iron combined with co-factor vitamins for better absorption and improved energy — supports anaemia management and reduces fatigue.",
    icon: Droplets,
    color: "#B45309",
  ...
  },
  {
    ...
    desc:
      "Calcium with vitamin D3 and supporting minerals — promotes strong bones, supports density and helps reduce age-related bone loss.",
    icon: Bone,
    color: "#475569",
  ...
  },
  {
    ...
    desc:
      "Glucosamine-based joint complex for cartilage, flexibility, and pain-free movement — built for active adults and ageing joints.",
    icon: Activity,
    color: "#0E7490",
  ...
  },
  {
    ...
    desc:
      "Targeted prostate support formula for men — helps maintain normal urinary function and prostate health as part of preventive men's wellness.",
    icon: Shield,
    color: "#0738A6",
  ...
  },
  {
    ...
    category: "Immunity",
    desc:
      "Triple-action immunity stack — Vitamin C, Vitamin D and Zinc work together to support immune defence, antioxidant balance, and recovery.",
    icon: ShieldCheck,
    color: "#F2C14E",
  ...
  },
  {
    ...
    desc:
      "Plant-based hepatoprotective formula — supports healthy liver function, helps detoxify and aids recovery from everyday liver stress.",
    icon: Leaf,
    color: "#5e8722",
  ...
  },
  {
    ...
    category: "All-in-One",
    desc:
      "Eight essential daily-wellness ingredients combined in a single tablet — a simple, complete supplement for those who prefer one tab over many.",
    icon: Sparkles,
    color: "#14B8A6",
  ...
  },
  {
    ...
    desc:
      "Brain and nerve support formula — combines B-complex vitamins and key neuro-nutrients to help maintain mental clarity and reduce nerve-related fatigue.",
    icon: Brain,
    color: "#6D28D9",
  ...
  },
  {
    ...
    desc:
      "High-quality fish oil delivering EPA and DHA omega-3 fatty acids — supports cardiovascular health, brain function and healthy inflammation response.",
    icon: Heart,
    color: "#E11D48",
  ...
  },
  {
    ...
    category: "Immunity",
    desc:
      "A daily immune-defence formula combining herbal extracts, vitamins and minerals — built to strengthen natural immunity year-round.",
    icon: ShieldCheck,
    color: "#9DCD4A",
  ...
  },
  {
    ...
    category: "Hydration",
    desc:
      "Oral rehydration salts with balanced electrolytes — restores hydration after exercise, illness, or hot-climate days. Fast, effective, family-safe.",
    icon: Droplets,
    color: "#62C7F5",
  ...
  },
  {
    ...
    desc:
      "Optimised daily vitamin capsule — a clean, well-balanced multivitamin designed for steady, all-round nutrition support.",
    icon: Eye,
    color: "#0EA5E9",

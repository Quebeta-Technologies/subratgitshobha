...
import { totalProducts, categories } from "../../../data/pharmaProducts";

export default function PharmaHero() {
  return (
    <section
      data-testid="pharma-hero"
    ...
    >
      {/* Decorative layers — match About / WhySobha hero style */}
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16 py-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-7">
              <Pill className="w-3.5 h-3.5 text-[#F2C14E]" />
            ...
            {/* H1 */}
            <h1
              data-testid="pharma-hero-headline"
            ...
            <p className="mt-7 text-white/75 text-[16px] md:text-[17px] leading-relaxed max-w-2xl">
              MDI Inhalers · B-Lactum Antibiotics · Injectables · Oncology &amp;
              Anti-Cancer · Cephalosporins — manufactured to EU-GMP &amp; WHO-GMP
              standards.
            </p>
          </motion.div>

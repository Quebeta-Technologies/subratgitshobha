...
const allProducts = [
  ...
  { tab: "MDI Inhalers", cat: "MDI Inhaler", color: "#62C7F5", name: "SYMFORA 6+200 MCG", spec: "Formoterol + Budesonide · 6+200 mcg · 120 Doses", desc: "Dual-action maintenance inhaler combining a long-acting beta-agonist with an inhaled steroid for asthma and COPD. Fast onset of formoterol provides both maintenance and reliever function.", form: "Inhaler", pack: "120 Doses", image: "/brand/mdi 8.png" },
  ...
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR 625", spec: "Amoxicillin Clavulanic Acid · 625 mg · 2×7 Tablets", desc: "Broad-spectrum antibiotic combination for respiratory, urinary tract, and skin infections. Clavulanate component prevents beta-lactamase resistance, extending coverage to resistant strains.", form: "Tablets", pack: "2×7", image: "/brand/b1.png" },
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR 1000", spec: "Amoxicillin Clavulanic Acid · 1000 mg · 2×7 Tablets", desc: "Higher-strength combination antibiotic for severe bacterial infections requiring increased amoxicillin dosing. Recommended for lower respiratory tract infections and complicated UTIs.", form: "Tablets", pack: "2×7", image: "/brand/b2.png" },
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR SYRUP 228.5", spec: "Amoxicillin Clavulanic Acid · 228.5 mg · 70 ml Syrup", desc: "Paediatric oral suspension for bacterial infections. Easy-to-administer syrup form for children requiring amoxicillin-clavulanate therapy. Pleasant taste for improved compliance.", form: "Syrup", pack: "70 ml", image: "/brand/b3.png" },
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR 457MG/70 ML", spec: "Amoxicillin Clavulanic Acid · 457 mg · 70 ml Syrup", desc: "Higher-strength paediatric suspension for moderate-to-severe bacterial infections in children. Appropriate for school-age children with community-acquired pneumonia or severe ear infections.", form: "Syrup", pack: "70 ml", image: "/brand/b4.png" },
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR-1125", spec: "Amoxicillin Clavulanic Acid · 1125 mg · 16×1 Sachets", desc: "Convenient sachet formulation for patients requiring high-dose amoxicillin-clavulanate therapy with easy compliance. Dissolves quickly in water — suitable for patients who cannot swallow large tablets.", form: "Sachets", pack: "16×1", image: "/brand/b5.png" },
  { tab: "B-Lactum Antibiotics", cat: "Anti Biotics", color: "#9DCD4A", name: "KESAR 562.5", spec: "Amoxicillin Clavulanic Acid · 562.5 mg · 16×1 Sachets", desc: "Sachet-form antibiotic combination for mid-range dosing. Ideal for patients who cannot swallow tablets, with precise dosing and easy preparation in clinic or home settings.", form: "Sachets", pack: "16×1", image: "/brand/b6.png" },

  // Injectables
  { tab: "Injectables", cat: "Injectables", color: "#E84D6C", name: "SHOBHA-SUNATE", spec: "Artesunate Injection · 60 MG / 120 MG · Vial", desc: "Fast-acting antimalarial injection for severe and complicated malaria. Proven efficacy against Plasmodium falciparum. WHO-recommended first-line treatment for severe malaria in adults and children.", form: "IV Injection", pack: "Each Vial", image: "/brand/i1.png" },
  { tab: "Injectables", cat: "Injectables", color: "#E84D6C", name: "PENTOPAZ", spec: "Pantoprazole Injection · 40 MG · Vial", desc: "IV proton pump inhibitor for stress ulcer prophylaxis and acute gastrointestinal bleeding in hospitalised patients. Rapid onset makes it suitable for emergency and ICU use.", form: "IV Injection", pack: "Each Vial", image: "/brand/i2.png" },
  { tab: "Injectables", cat: "Injectables", color: "#E84D6C", name: "ESOPAZ 40MG", spec: "Esomeprazole Injection · 40 MG · Vial", desc: "Injectable PPI for patients unable to take oral medication. Controls gastric acid secretion effectively in critical care. Proven bioavailability and consistent acid suppression.", form: "IV Injection", pack: "Each Vial", image: "/brand/263-260.jpg" },
  { tab: "Injectables", cat: "Injectables", color: "#E84D6C", name: "OMPRA-40 MG", spec: "Omeprazole Injection · 40 MG · Vial", desc: "Parenteral omeprazole for acid-peptic disorders in ICU and post-operative settings where oral therapy is not feasible. Cost-effective IV PPI option with reliable efficacy.", form: "IV Injection", pack: "Each Vial", image: "/brand/i4.png" },
  { tab: "Injectables", cat: "Injectables", color: "#E84D6C", name: "KERONIM", spec: "Meropenem Injection · 500 MG / 1 GM · Vial", desc: "Broad-spectrum carbapenem antibiotic for life-threatening infections including sepsis, pneumonia, and meningitis. Last-resort antibiotic with activity against multi-drug-resistant organisms.", form: "IV Injection", pack: "Each Vial", image: "/brand/i5.png" },

  // Oncology
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "PRABOPLATIN", spec: "Carboplatin Injection · 150 mg / 450 mg · Injectable", desc: "Cornerstone chemotherapy for lung, ovarian, and head & neck cancers. IV infusion after dilution. Better tolerated than Cisplatin with comparable efficacy in many tumour types.", form: "IV Infusion", pack: "Each Vial", image: "/brand/o1.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "SHO-PRA", spec: "Cisplatin Injection · 10 MG / 50 MG · Injectable", desc: "One of the most widely used chemotherapy drugs globally — effective against testicular, bladder, lung, and ovarian cancers. The gold standard platinum-based agent in oncology protocols.", form: "IV Infusion", pack: "Each Vial", image: "/brand/o2.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "SIKLESIA", spec: "Hydroxy Urea · 500 mg · 10×10 Capsules", desc: "Cytoreductive therapy for chronic myeloid leukaemia, sickle cell disease, and polycythaemia vera. Oral administration simplifies treatment in resource-limited settings.", form: "Capsules", pack: "10×10", image: "/brand/o3.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "PRACITABIN", spec: "Capecitabine Tablets · 500 mg · 10×10", desc: "Oral chemotherapy for breast and colorectal cancers. Easier to administer than IV therapy and equally effective. Prodrug that converts to 5-FU selectively within tumour tissue.", form: "Tablets", pack: "10×10", image: "/brand/o4.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "METHOTRAX", spec: "Methotrexate Injection · 50 / 500 / 1000 mg", desc: "Antimetabolite chemotherapy for leukaemia, lymphoma, osteosarcoma, and autoimmune conditions at high doses. Decades of clinical evidence and well-established dosing protocols.", form: "IV Injection", pack: "Each Vial", image: "/brand/o5.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "TOMAGIFEN", spec: "Tamoxifen Citrate · 10 mg / 20 mg · 10×3 Capsules", desc: "Hormone therapy for ER-positive breast cancer. One of the most established cancer medicines available globally. Used for treatment and prevention in high-risk patients.", form: "Capsules", pack: "10×3", image: "/brand/o6.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "OTINIB", spec: "Osimertinib Tablets · 40 mg / 80 mg · 30's", desc: "Third-generation EGFR inhibitor for non-small cell lung cancer with T790M mutation. Once-daily targeted therapy with superior CNS penetration compared to earlier EGFR inhibitors.", form: "Tablets", pack: "30's", image: "/brand/o7.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "PRAZOSIB", spec: "Olaparib Tablets · 150 mg · 30's", desc: "PARP inhibitor for BRCA-mutated ovarian, breast, and prostate cancers. Maintenance therapy after platinum chemotherapy with significant improvement in progression-free survival.", form: "Tablets", pack: "30's", image: "/brand/o8.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "SIMLARO", spec: "Ixazomib Capsule · 4 mg · 3 Capsules", desc: "Oral proteasome inhibitor for relapsed/refractory multiple myeloma. Used in combination with lenalidomide and dexamethasone. First oral proteasome inhibitor approved for myeloma.", form: "Capsules", pack: "3 Capsules", image: "/brand/o9.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "PRABLOCIB", spec: "Palbociclib Tablets · 125 mg · 21 Capsules", desc: "CDK 4/6 inhibitor for HR-positive, HER2-negative advanced breast cancer. Used in combination with endocrine therapy, showing significantly improved progression-free survival.", form: "Capsules", pack: "21 Capsules", image: "/brand/o10.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "DOXACORT", spec: "Doxorubicin Injection · 50 mg IV", desc: "Anthracycline chemotherapy for breast, ovarian, and haematological cancers. Used in multiple combination regimens including AC, CHOP, and ABVD. Proven cornerstone of oncology.", form: "IV Injection", pack: "Each Vial", image: "/brand/o11.png" },
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "RITUMAB", spec: "Rituximab Injection · 100 mg/10 ml", desc: "Anti-CD20 monoclonal antibody for B-cell lymphomas, CLL, and rheumatoid arthritis. Targeted biological therapy that depletes CD20-positive B cells with high specificity.", form: "IV Infusion", pack: "Each Vial", image: "/brand/o12.png" },

  // Cephalosporins
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "FEEZA-250", spec: "Cefuroxime · 250 mg · 10's Tablets", desc: "Second-generation cephalosporin for upper respiratory, urinary tract, and skin infections. Broad gram-positive and gram-negative coverage with good oral bioavailability.", form: "Tablets", pack: "10's", image: "/brand/ce1.png" },
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "FEEZA-500", spec: "Cefuroxime · 500 mg · 10's Tablets", desc: "Higher-strength cefuroxime for moderate-to-severe bacterial infections requiring increased dosing. Effective for community-acquired pneumonia and complicated urinary tract infections.", form: "Tablets", pack: "10's", image: "/brand/ce2.png" },
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "ZORA-500 MG", spec: "Ceftriaxone INJ · 500 MG / 1 GM · Vial", desc: "Third-generation cephalosporin for serious infections including meningitis, septicaemia, and gonorrhoea. Once-daily dosing due to long half-life improves compliance in hospital settings.", form: "IV/IM Injection", pack: "Each Vial", image: "/brand/ce3.png" },
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "KEFBACTUM 1.5", spec: "Ceftriaxone + Sulbactam INJ · 1.5 GM · Vial", desc: "Beta-lactamase inhibitor combination for resistant infections including hospital-acquired pneumonia and sepsis. Sulbactam restores activity against otherwise resistant Acinetobacter and other organisms.", form: "IV Injection", pack: "Each Vial", image: "/brand/263-260.jpg" },
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "KEZIDIME 1GM", spec: "Ceftazidime INJ · 1 GM · Vial", desc: "Third-generation cephalosporin with strong Pseudomonas coverage for severe hospital-acquired infections. Preferred for febrile neutropenia and nosocomial infections in immunocompromised patients.", form: "IV Injection", pack: "Each Vial", image: "/brand/263-260.jpg" },
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "KEFUROX-750", spec: "Cefuroxime INJ · 750 MG · Vial", desc: "Injectable cefuroxime for peri-operative prophylaxis and serious infections requiring parenteral therapy. Widely used in surgical prophylaxis protocols across orthopaedic and abdominal procedures.", form: "IV/IM Injection", pack: "Each Vial", image: "/brand/263-260.jpg" },
];

...
const allProducts = [
  ...
  { tab: "Oncology", cat: "Oncology", color: "#0738A6", name: "METHOTRAX", spec: "Methotrexate Injection · 50 / 500 / 1000 mg", desc: "Antimetabolite chemotherapy for leukaemia, lymphoma, osteosarcoma, and autoimmune conditions at high doses. Decades of clinical evidence and well-established dosing protocols.", form: "IV Injection", pack: "Each Vial", image: "/brand/methotrax.png" },

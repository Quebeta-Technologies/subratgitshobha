...
const allProducts = [
  ...
  { tab: "MDI Inhalers", cat: "MDI Inhaler", color: "#62C7F5", name: "BD-ASMA-250 MCG", spec: "Beclometasone Dipropionate · 250 mcg/dose · 200 Doses", desc: "Higher-strength inhaled steroid for moderate-to-severe asthma. Proven, reliable, and accessible for long-term management where lower doses are insufficient.", form: "Inhaler", pack: "200 Doses", image: "/brand/shobha 1.png" },

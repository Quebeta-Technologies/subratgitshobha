...
const allProducts = [
  ...
  { tab: "Cephalosporins", cat: "Cephalosporins", color: "#7A1F7A", name: "ZORAIGM / 500 MG", spec: "Ceftriaxone INJ · 500 MG / 1 GM · Vial", desc: "Third-generation cephalosporin for serious infections including meningitis, septicaemia, and gonorrhoea. Once-daily dosing due to long half-life improves compliance in hospital settings.", form: "IV/IM Injection", pack: "Each Vial", image: "/brand/ce3.png" },
